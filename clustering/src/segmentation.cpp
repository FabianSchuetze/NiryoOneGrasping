...
template <typename T>
PlaneSegmentation<T>::PlaneSegmentation(std::size_t max_iterations,
                                        float distance) {
...
template <typename T>
void PlaneSegmentation<T>::setInputCloud(
...
template void
extractPlane<pcl::PointXYZ>(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr &,
                            pcl::PointCloud<pcl::PointXYZ>::Ptr &,
                            pcl::PointIndices::Ptr, bool);
